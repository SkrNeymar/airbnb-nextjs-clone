...
const Modal = (props) => {
  ...
  return (
    <>
      <div className="fixed inset-0 z-50 flex items-center justify-center overflow-x-hidden overflow-y-auto outline-none select-none focus:outline-none bg-neutral-800/70">
